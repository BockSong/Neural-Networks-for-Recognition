...
batch_size = 8
learning_rate = 1e-3
input_size = 32 # 1024 = 32 * 32
cnn_layers = [4, 'P']
linear_layers = [1024, 36] # 1024 * 4 / (2*2) = 1024
...
if __name__ == '__main__':
    ...
    train_x = np.reshape(train_x, (train_x.shape[0], 1, input_size, input_size))
    #print(train_x.shape)
